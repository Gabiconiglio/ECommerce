...
function Notfound404(){
    return(
        ...
        <Link to={"/"}>
        <button className="btn btn-outline" id="btnNot"><img src={Marioicon} className="iconNot" />Go Home</button>
        </Link>
        <p id="txt2Notfound">If you want to save yourself from Bowser's attack, use the button that will take you to the castle.</p>
        </>
    );
}
